...
const User = () => {
  ...
  return (
    <Layout>
          ...
          <div className="bg-white w-full xl:px-10 px-4 py-5 lg:h-[35rem] shadow-2xl">
            ...
            <div className="flex flex-col gap-10 lg:grid-cols-2 lg:grid">
              <div
                ...
                className="border flex items-center justify-between py-3 px-2"
              >
              ...
              <div
                ...
                className="border py-3 px-2 items-center justify-between flex w-full"
              >
                <Link to="">Change Password</Link> <FaChevronRight />
              </div>
              <div
                onClick={handleOpenSettings}
                className="border py-3 px-2 items-center justify-between flex w-full"
              >
                <Link to="">Settings</Link> <FaChevronRight />
              </div>
              ...
              <div
                ...
                className="border py-3 px-2 items-center justify-between flex w-full"
              >
                <Link to="">Favourite Service</Link> <FaChevronRight />
              </div>
      ...
      {isModalOpen && <FavouriteService closeview={handleCloseModal} />}
      {changePass && <ChangePassword closeview={handleCloseChangePass} />}
      {fundWallet && <FundWallet closeview={handleCloseFundWallet} />}
      {settings && <Settings closeview={handleCloseSettings} />}
    </Layout>
  );
};
