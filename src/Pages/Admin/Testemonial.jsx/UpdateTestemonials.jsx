...
const UpdateTestemonials = ({ closeView, singles, resendSignal }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await AuthPosturl(Apis.admins.update_testemonials, dataToSend);
      if (res.status) {
  ...
  return (
    <ModalLayout closeView={closeView}>
      <div className="bg-white w-[95%] mx-auto text-primary h-[27rem] pt-10 overflow-hidden scrollsdown">
        <div className="text-slate-600 text-xl rounded-lg shadow-xl mb-5 bg-blue-50 p-3">Update Testemonial</div>
...
export default UpdateTestemonials;